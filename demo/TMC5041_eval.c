...
static uint32_t rotate(uint8_t motor, int32_t velocity)
{
	...
	TMC5041_CHIP1.vMaxModified[motor] = true;
...
static uint32_t handleParameter(uint8_t readWrite, uint8_t motor, uint8_t type, int32_t *value)
{
	...
	case 6:
		// Maximum current
		if(readWrite == READ) {
			*value = TMC5041_FIELD_READ(&TMC5041_CHIP1, TMC5041_IHOLD_IRUN(motor), TMC5041_IRUN_MASK, TMC5041_IRUN_SHIFT);
		} else if(readWrite == WRITE) {
			TMC5041_FIELD_WRITE(&TMC5041_CHIP1, TMC5041_IHOLD_IRUN(motor), TMC5041_IRUN_MASK, TMC5041_IRUN_SHIFT, *value);
		}
		break;
	case 7:
		// Standby current
		if(readWrite == READ) {
			*value = TMC5041_FIELD_READ(&TMC5041_CHIP1, TMC5041_IHOLD_IRUN(motor), TMC5041_IHOLD_MASK, TMC5041_IHOLD_SHIFT);
		} else if(readWrite == WRITE) {
			TMC5041_FIELD_WRITE(&TMC5041_CHIP1, TMC5041_IHOLD_IRUN(motor), TMC5041_IHOLD_MASK, TMC5041_IHOLD_SHIFT, *value);
		}
		break;
	case 8:
		// Position reached flag
		if(readWrite == READ) {
			*value = TMC5041_FIELD_READ(&TMC5041_CHIP1, TMC5041_RAMPSTAT(motor), TMC5041_POSITION_REACHED_MASK, TMC5041_POSITION_REACHED_SHIFT);
		} else if(readWrite == WRITE) {
			errors |= TMC_ERROR_TYPE;
		}
		break;
	case 10:
		// Right endstop
		if(readWrite == READ) {
			*value = !TMC5041_FIELD_READ(&TMC5041_CHIP1, TMC5041_RAMPSTAT(motor), TMC5041_STATUS_STOP_R_MASK, TMC5041_STATUS_STOP_R_SHIFT);
		} else if(readWrite == WRITE) {
			errors |= TMC_ERROR_TYPE;
		}
		break;
	case 11:
		// Left endstop
		if(readWrite == READ) {
			*value = !TMC5041_FIELD_READ(&TMC5041_CHIP1, TMC5041_RAMPSTAT(motor), TMC5041_STATUS_STOP_L_MASK, TMC5041_STATUS_STOP_L_SHIFT);
		} else if(readWrite == WRITE) {
			errors |= TMC_ERROR_TYPE;
		}
		break;
	case 12:
		...
		if(readWrite == READ) {
			*value = TMC5041_FIELD_READ(&TMC5041_CHIP1, TMC5041_SWMODE(motor), TMC5041_STOP_R_ENABLE_MASK, TMC5041_STOP_R_ENABLE_SHIFT);
		} else if(readWrite == WRITE) {
			TMC5041_FIELD_WRITE(&TMC5041_CHIP1, TMC5041_SWMODE(motor), TMC5041_STOP_R_ENABLE_MASK, TMC5041_STOP_R_ENABLE_SHIFT, (*value)? 1:0);
			TMC5041_FIELD_WRITE(&TMC5041_CHIP1, TMC5041_SWMODE(motor), TMC5041_POL_STOP_R_MASK, TMC5041_POL_STOP_R_SHIFT, (*value==2)? 1:0);
		}
		break;
	case 13:
		// Automatic left stop
		if(readWrite == READ) {
			*value = TMC5041_FIELD_READ(&TMC5041_CHIP1, TMC5041_SWMODE(motor), TMC5041_STOP_L_ENABLE_MASK, TMC5041_STOP_L_ENABLE_SHIFT);
		} else if(readWrite == WRITE) {
			TMC5041_FIELD_WRITE(&TMC5041_CHIP1, TMC5041_SWMODE(motor), TMC5041_STOP_L_ENABLE_MASK, TMC5041_STOP_L_ENABLE_SHIFT, (*value)? 1:0);
			TMC5041_FIELD_WRITE(&TMC5041_CHIP1, TMC5041_SWMODE(motor), TMC5041_POL_STOP_L_MASK, TMC5041_POL_STOP_L_SHIFT, (*value==2)? 1:0);
		}
		break;
	case 14:
		// SW_MODE Register
	...
	case 28:
		...
		if(readWrite == READ) {
			*value = TMC5041_FIELD_READ(&TMC5041_CHIP1, TMC5041_CHOPCONF(motor), TMC5041_VHIGHFS_MASK, TMC5041_VHIGHFS_SHIFT);
		} else if(readWrite == WRITE) {
			TMC5041_FIELD_WRITE(&TMC5041_CHIP1, TMC5041_CHOPCONF(motor), TMC5041_VHIGHFS_MASK, TMC5041_VHIGHFS_SHIFT, *value);
		}
		break;
	case 29:	// todo AP XML 2: Beschreibung vom AP fehlt (LH)
		if(readWrite == READ) {
			*value = TMC5041_CHIP1.velocity[motor];
		} else if(readWrite == WRITE) {
			errors |= TMC_ERROR_TYPE;
		}
		break;
	case 140:
		...
		if(readWrite == READ) {
			*value = 256 >> TMC5041_FIELD_READ(&TMC5041_CHIP1, TMC5041_CHOPCONF(motor), TMC5041_MRES_MASK, TMC5041_MRES_SHIFT);
		} else if(readWrite == WRITE) {
			switch(*value)
			{
			...
			if(*value != -1)
			{
				TMC5041_FIELD_WRITE(&TMC5041_CHIP1, TMC5041_CHOPCONF(motor), TMC5041_MRES_MASK, TMC5041_MRES_SHIFT, *value);
			}
	...
	case 162:
		// Chopper blank time
		if(readWrite == READ) {
			*value = TMC5041_FIELD_READ(&TMC5041_CHIP1, TMC5041_CHOPCONF(motor), TMC5041_TBL_MASK, TMC5041_TBL_SHIFT);
		} else if(readWrite == WRITE) {
			TMC5041_FIELD_WRITE(&TMC5041_CHIP1, TMC5041_CHOPCONF(motor), TMC5041_TBL_MASK, TMC5041_TBL_SHIFT, *value);
		}
		break;
	case 163:
		// Constant TOff Mode
		if(readWrite == READ) {
			*value = TMC5041_FIELD_READ(&TMC5041_CHIP1, TMC5041_CHOPCONF(motor), TMC5041_CHM_MASK, TMC5041_CHM_SHIFT);
		} else if(readWrite == WRITE) {
			TMC5041_FIELD_WRITE(&TMC5041_CHIP1, TMC5041_CHOPCONF(motor), TMC5041_CHM_MASK, TMC5041_CHM_SHIFT, *value);
		}
		break;
	case 164:
		// Disable fast decay comparator
		if(readWrite == READ) {
			*value = TMC5041_FIELD_READ(&TMC5041_CHIP1, TMC5041_CHOPCONF(motor), TMC5041_DISFDCC_MASK, TMC5041_DISFDCC_SHIFT);
		} else if(readWrite == WRITE) {
			TMC5041_FIELD_WRITE(&TMC5041_CHIP1, TMC5041_CHOPCONF(motor), TMC5041_DISFDCC_MASK, TMC5041_DISFDCC_SHIFT, *value);
		}
		break;
	case 165:
		...
		if(readWrite == READ) {
			...
			{
				*value = TMC5041_FIELD_READ(&TMC5041_CHIP1, TMC5041_CHOPCONF(motor), TMC5041_HEND_MASK, TMC5041_HEND_SHIFT);
			}
			else
			{
			...
			if(tempValue & TMC5041_CHM_MASK)
			{
				TMC5041_FIELD_WRITE(&TMC5041_CHIP1, TMC5041_CHOPCONF(motor), TMC5041_HEND_MASK, TMC5041_HEND_SHIFT, *value);
			}
			else
			{
				TMC5041_FIELD_WRITE(&TMC5041_CHIP1, TMC5041_CHOPCONF(motor), TMC5041_TFD_3_MASK, TMC5041_TFD_3_SHIFT, (*value & (1<<3))? 1:0);

				TMC5041_FIELD_WRITE(&TMC5041_CHIP1, TMC5041_CHOPCONF(motor), TMC5041_TFD_ALL_MASK, TMC5041_TFD_ALL_SHIFT, *value);
			}
		}
		break;
	case 166:
		...
		if(readWrite == READ) {
			if(tempValue & TMC5041_CHM_MASK)
			{
				*value = TMC5041_FIELD_READ(&TMC5041_CHIP1, TMC5041_CHOPCONF(motor), TMC5041_HSTRT_MASK, TMC5041_HSTRT_SHIFT);
			}
			else
			{
				*value = TMC5041_FIELD_READ(&TMC5041_CHIP1, TMC5041_CHOPCONF(motor), TMC5041_OFFSET_MASK, TMC5041_OFFSET_SHIFT);
				if(tempValue & TMC5041_TFD_3_MASK)
			...
			{
				TMC5041_FIELD_WRITE(&TMC5041_CHIP1, TMC5041_CHOPCONF(motor), TMC5041_HSTRT_MASK, TMC5041_HSTRT_SHIFT, *value);
			}
			else
			{
				TMC5041_FIELD_WRITE(&TMC5041_CHIP1, TMC5041_CHOPCONF(motor), TMC5041_OFFSET_MASK, TMC5041_OFFSET_SHIFT, *value);
			}
		}
		break;
	case 167:
		// Chopper off time
		if(readWrite == READ) {
			*value = TMC5041_FIELD_READ(&TMC5041_CHIP1, TMC5041_CHOPCONF(motor), TMC5041_TOFF_MASK, TMC5041_TOFF_MASK);
		} else if(readWrite == WRITE) {
			TMC5041_FIELD_WRITE(&TMC5041_CHIP1, TMC5041_CHOPCONF(motor), TMC5041_TOFF_MASK, TMC5041_TOFF_MASK, *value);
		}
		break;
	case 168:
		// smartEnergy current minimum (SEIMIN)
		if(readWrite == READ) {
			*value = TMC5041_FIELD_READ(&TMC5041_CHIP1, TMC5041_COOLCONF(motor), TMC5041_SEIMIN_MASK, TMC5041_SEIMIN_SHIFT);
		} else if(readWrite == WRITE) {
			TMC5041_FIELD_WRITE(&TMC5041_CHIP1, TMC5041_COOLCONF(motor), TMC5041_SEIMIN_MASK, TMC5041_SEIMIN_SHIFT, *value);
		}
		break;
	case 169:
		// smartEnergy current down step
		if(readWrite == READ) {
			*value = TMC5041_FIELD_READ(&TMC5041_CHIP1, TMC5041_COOLCONF(motor), TMC5041_SEDN_MASK, TMC5041_SEDN_SHIFT);
		} else if(readWrite == WRITE) {
			TMC5041_FIELD_WRITE(&TMC5041_CHIP1, TMC5041_COOLCONF(motor), TMC5041_SEDN_MASK, TMC5041_SEDN_SHIFT, *value);
		}
		break;
	case 170:
		// smartEnergy hysteresis
		if(readWrite == READ) {
			*value = TMC5041_FIELD_READ(&TMC5041_CHIP1, TMC5041_COOLCONF(motor), TMC5041_SEMAX_MASK, TMC5041_SEMAX_SHIFT);
		} else if(readWrite == WRITE) {
			TMC5041_FIELD_WRITE(&TMC5041_CHIP1, TMC5041_COOLCONF(motor), TMC5041_SEMAX_MASK, TMC5041_SEMAX_SHIFT, *value);
		}
		break;
	case 171:
		// smartEnergy current up step
		if(readWrite == READ) {
			*value = TMC5041_FIELD_READ(&TMC5041_CHIP1, TMC5041_COOLCONF(motor), TMC5041_SEUP_MASK, TMC5041_SEUP_SHIFT);
		} else if(readWrite == WRITE) {
			TMC5041_FIELD_WRITE(&TMC5041_CHIP1, TMC5041_COOLCONF(motor), TMC5041_SEUP_MASK, TMC5041_SEUP_SHIFT, *value);
		}
		break;
	case 172:
		// smartEnergy hysteresis start
		if(readWrite == READ) {
			*value = TMC5041_FIELD_READ(&TMC5041_CHIP1, TMC5041_COOLCONF(motor), TMC5041_SEMIN_MASK, TMC5041_SEMIN_SHIFT);
		} else if(readWrite == WRITE) {
			TMC5041_FIELD_WRITE(&TMC5041_CHIP1, TMC5041_COOLCONF(motor), TMC5041_SEMIN_MASK, TMC5041_SEMIN_SHIFT, *value);
		}
		break;
	case 173:
		// stallGuard2 filter enable
		if(readWrite == READ) {
			*value = TMC5041_FIELD_READ(&TMC5041_CHIP1, TMC5041_COOLCONF(motor), TMC5041_SFILT_MASK, TMC5041_SFILT_SHIFT);
		} else if(readWrite == WRITE) {
			TMC5041_FIELD_WRITE(&TMC5041_CHIP1, TMC5041_COOLCONF(motor), TMC5041_SFILT_MASK, TMC5041_SFILT_SHIFT, *value);
		}
		break;
	case 174:
		// stallGuard2 threshold
		if(readWrite == READ) {
			*value = TMC5041_FIELD_READ(&TMC5041_CHIP1, TMC5041_COOLCONF(motor), TMC5041_SGT_MASK, TMC5041_SGT_SHIFT);
			*value = CAST_Sn_TO_S32(*value, 7);
		} else if(readWrite == WRITE) {
			TMC5041_FIELD_WRITE(&TMC5041_CHIP1, TMC5041_COOLCONF(motor), TMC5041_SGT_MASK, TMC5041_SGT_SHIFT, *value);
		}
		break;
	case 179:
		// VSense
		if(readWrite == READ) {
			*value = TMC5041_FIELD_READ(&TMC5041_CHIP1, TMC5041_CHOPCONF(motor), TMC5041_VSENSE_MASK, TMC5041_VSENSE_SHIFT);
		} else if(readWrite == WRITE) {
			TMC5041_FIELD_WRITE(&TMC5041_CHIP1, TMC5041_CHOPCONF(motor), TMC5041_VSENSE_MASK, TMC5041_VSENSE_SHIFT, *value);
		}
		break;
	case 180:
		// smartEnergy actual current
		if(readWrite == READ) {
			*value = TMC5041_FIELD_READ(&TMC5041_CHIP1, TMC5041_DRVSTATUS(motor), TMC5041_CS_ACTUAL_MASK, TMC5041_CS_ACTUAL_SHIFT);
		} else if(readWrite == WRITE) {
			errors |= TMC_ERROR_TYPE;
		}
		break;
	case 181:
		...
		if(readWrite == READ) {
			*value = tmc5041_readInt(motorToIC(motor), TMC5041_VCOOLTHRS(motor));
			...
			tmc5041_writeInt(motorToIC(motor), TMC5041_VCOOLTHRS(motor),*value);
			TMC5041_FIELD_WRITE(&TMC5041_CHIP1, TMC5041_SWMODE(motor), TMC5041_SG_STOP_MASK, TMC5041_SG_STOP_SHIFT, (*value)? 1:0);
		}
		break;
	case 182:
		// smartEnergy threshold speed
	...
	case 184:
		// Random TOff mode
		if(readWrite == READ) {
			*value = TMC5041_FIELD_READ(&TMC5041_CHIP1, TMC5041_CHOPCONF(motor), TMC5041_RNDTF_MASK, TMC5041_RNDTF_SHIFT);
		} else if(readWrite == WRITE) {
			TMC5041_FIELD_WRITE(&TMC5041_CHIP1, TMC5041_CHOPCONF(motor), TMC5041_RNDTF_MASK, TMC5041_RNDTF_SHIFT, *value);
		}
		break;
	case 206:
		// Load value
		if(readWrite == READ) {
			*value = TMC5041_FIELD_READ(&TMC5041_CHIP1, TMC5041_DRVSTATUS(motor), TMC5041_SG_RESULT_MASK, TMC5041_SG_RESULT_SHIFT);
		} else if(readWrite == WRITE) {
			errors |= TMC_ERROR_TYPE;
		}
		break;
...
{
	UNUSED(motor);
	tmc5041_writeInt(&TMC5041_CHIP1, (uint8_t) address, value);
}

static void readRegister(uint8_t motor, uint16_t address, int32_t *value)
{
	UNUSED(motor);
	*value = tmc5041_readInt(&TMC5041_CHIP1, (uint8_t) address);
}
...
// {
// 	tmc5041_init(&TMC5041_CHIP1, 0, Evalboards.ch1.config, tmc5041_defaultRegisterResetState);
